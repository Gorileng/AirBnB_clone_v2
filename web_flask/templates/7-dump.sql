...
-- Creates the database + the user if does not exist
...
--
-- Table structures for the table `cities`
--
...
--
-- Dumping data for the table `cities`
--
...
--
-- Table structure for the table `states`
--
...
--
-- Dumping data for the table `states`
--
